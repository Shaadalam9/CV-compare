...
## Getting started
[![Python Version](https://img.shields.io/badge/python-3.13.3-blue.svg)](https://www.python.org/downloads/release/python-3919/)
[![Package Manager: uv](https://img.shields.io/badge/package%20manager-uv-green)](https://docs.astral.sh/uv/)

Tested with **Python 3.13.3** and the [`uv`](https://docs.astral.sh/uv/) package manager.  
...
```command line
git clone https://github.com/shaadalam9/cv-compare
cd cv-compare
```

**Step 5:** Ensure correct Python version. If you don’t already have Python 3.13.3 installed, let `uv` fetch it:
```command line
